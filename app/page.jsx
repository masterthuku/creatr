...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden relative">
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-2xl md:max-w-none">
                ...
                and helps you build a thriving community
              </p>
            </div>
      ...
      <section
        id="features"
        className="relative z-10 mt-14 py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-r from-gray-900/50 to-purple-900/20"
      >
      ...
      <footer className="relative z-10 border-t py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-muted-foreground">
            ...
            <span className="text-foreground font-semibold">Creatr</span>. All
            rights reserved.
          </p>
        </div>
      </footer>
