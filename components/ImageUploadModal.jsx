...
const ImageUploadModal = ({
  ...
  const onDrop = async (acceptedFiles) => {
    ...
    setIsUploading(true);
    try {
      const fileName = `post_image_${Date.now()}_${file.name}`;
  ...
  const applyTransformations = async () => {
    ...
    try {
      ...
      if (watchedValues.textOverlay?.trim()) {
        const safeColor = watchedValues.textColor || "#ffffff";
        transformationChain.push({
          overlayText: watchedValues.textOverlay,
          overlayTextFontSize: watchedValues.textFontSize || 50,
          overlayTextColor: safeColor.replace("#", ""),
      ...
      toast.error("An error occurred during image transformation.");
    } finally {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className={"!max-w-6xl !h-[90vh] overflow-y-auto"}>
        <DialogHeader>
          ...
          <DialogDescription>
            Uplaod an image and apply AI-powered transformations.
          </DialogDescription>
        </DialogHeader>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-2">
                      or click to select one (JPEG, PNG, GIF, WEBP - max 10MB)
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                    ...
                    <p className="text-sm text-slate-400">
                      AI powered background removal for a clean look.
                    </p>
                  </div>
                  {/* dropshadow */}
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue defaultValue="original" />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  {watchedValues.aspectRatio !== "original" && (
                    <div className="space-y-3">
                      <Label className={"text-white"}>Crop Focus</Label>
                      <Select
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      type="color"
                      value={watchedValues.textColor || "#ffffff"}
